...
/**
 * PAZ-3205: a tall passenger bus on the same basic leaf-sprung live axles as
 * SUSP_TRUCK, but carrying people over cargo. Softer at both ends and more
 * bump travel than an empty flatbed, so the tall body settles rather than
 * hopping; the rear stays slightly quicker than the front for a flat ride
 * under a full standing load.
 */
const SUSP_PAZ: SuspensionTuning = {
  frontHz: 1.0,
  rearHz: 1.15,
  compressionRatio: 0.2,
  reboundRatio: 0.34,
...
const FACTORY_GEOMETRY: Readonly<Record<string, FactoryGeometry>> = {
  ...
  // GAZ-31029 Volga (1992-1997), 205/70R14. Wheelbase/track/clearance/mass from
  // published factory data; rolling radius computed from the tyre code.
  gt_gaz31029:    { length: 4.885, width: 1.800, height: 1.476, clearance: 0.156, wheelbase: 2.800, frontTrack: 1.495, rearTrack: 1.425, wheelRadius: 0.321, tyreWidth: 0.205 },
  gt_gaz3102    : { length: 4.960, width: 1.800, height: 1.422, clearance: 0.156, wheelbase: 2.800, frontTrack: 1.500, rearTrack: 1.444, wheelRadius: 0.3172, tyreWidth: 0.1950 },
  gt_niva_bronto: { length: 3.740, width: 1.713, height: 1.900, clearance: 0.240, wheelbase: 2.200, frontTrack: 1.526, rearTrack: 1.506, wheelRadius: 0.3668, tyreWidth: 0.2350 },
  gt_uaz469     : { length: 4.025, width: 1.785, height: 2.050, clearance: 0.220, wheelbase: 2.380, frontTrack: 1.445, rearTrack: 1.445, wheelRadius: 0.3840, tyreWidth: 0.2150 },
  gt_zil130     : { length: 6.675, width: 2.500, height: 2.400, clearance: 0.275, wheelbase: 3.800, frontTrack: 1.800, rearTrack: 1.790, wheelRadius: 0.5050, tyreWidth: 0.2600 },
  gt_izh412     : { length: 4.205, width: 1.555, height: 1.500, clearance: 0.173, wheelbase: 2.400, frontTrack: 1.270, rearTrack: 1.270, wheelRadius: 0.2970, tyreWidth: 0.1650 },
  gt_paz3205    : { length: 7.000, width: 2.480, height: 2.960, clearance: 0.264, wheelbase: 3.600, frontTrack: 1.940, rearTrack: 1.690, wheelRadius: 0.4636, tyreWidth: 0.2095 },
  gt_vaz21099   : { length: 4.205, width: 1.650, height: 1.402, clearance: 0.160, wheelbase: 2.460, frontTrack: 1.400, rearTrack: 1.370, wheelRadius: 0.2876, tyreWidth: 0.1750 },
  gt_vaz2101    : { length: 4.073, width: 1.611, height: 1.440, clearance: 0.170, wheelbase: 2.424, frontTrack: 1.349, rearTrack: 1.305, wheelRadius: 0.2970, tyreWidth: 0.1550 },
  ...
  gt_vaz2103    : { length: 4.116, width: 1.611, height: 1.440, clearance: 0.170, wheelbase: 2.424, frontTrack: 1.365, rearTrack: 1.321, wheelRadius: 0.2971, tyreWidth: 0.1650 },
  gt_vaz2102    : { length: 4.059, width: 1.611, height: 1.458, clearance: 0.170, wheelbase: 2.424, frontTrack: 1.365, rearTrack: 1.321, wheelRadius: 0.2970, tyreWidth: 0.1650 },
  gt_gaz31022   : { length: 4.885, width: 1.800, height: 1.576, clearance: 0.156, wheelbase: 2.800, frontTrack: 1.476, rearTrack: 1.420, wheelRadius: 0.3210, tyreWidth: 0.2050 },
  gt_vaz2105    : { length: 4.130, width: 1.620, height: 1.446, clearance: 0.170, wheelbase: 2.424, frontTrack: 1.365, rearTrack: 1.321, wheelRadius: 0.2876, tyreWidth: 0.1750 },
  gt_vaz2104    : { length: 4.115, width: 1.620, height: 1.443, clearance: 0.170, wheelbase: 2.424, frontTrack: 1.365, rearTrack: 1.321, wheelRadius: 0.2971, tyreWidth: 0.1650 },
  gt_gazel      : { length: 5.500, width: 1.966, height: 2.200, clearance: 0.190, wheelbase: 2.900, frontTrack: 1.700, rearTrack: 1.690, wheelRadius: 0.3430, tyreWidth: 0.1850 },
  gt_uaz3962    : { length: 4.440, width: 1.940, height: 2.101, clearance: 0.220, wheelbase: 2.300, frontTrack: 1.445, rearTrack: 1.445, wheelRadius: 0.4250, tyreWidth: 0.2134 },
  gt_gazm20     : { length: 4.665, width: 1.695, height: 1.640, clearance: 0.200, wheelbase: 2.700, frontTrack: 1.364, rearTrack: 1.362, wheelRadius: 0.3400, tyreWidth: 0.1600 },
};
...
const GTAV_SPECS: readonly Entry[] = [
  ...
  },
  {
    ...
    steerLock: 0.5,
    rearDriveBias: 1,
    // GAZ-3110's measured Cx (0.461, same platform's direct facelift) over an
    // estimated frontal area (1.800 x 1.476 m box, 0.82 shape factor).
    dragArea: 1.0,
    // A body-skin hub bone travels separately from the shared wheel drawable
    // in this donor; see the hub routing note in tools/import-yft-vehicle.py.
    wheelNodes: {
      wheel_fl: ['wheel_fl', 'hub_fl'],
      wheel_fr: ['wheel_fr', 'hub_fr'],
      wheel_rl: ['wheel_rl', 'hub_rl'],
  ...
  },
  {
    ...
    scale: 0.937,
    mass: 1450,
    engineId: 'engine_zmz_4062',
    gearboxId: 'gearbox_gaz_5',
    tankLitres: 70,
    wheelGrip: 0.58,
    suspension: SUSP_VOLGA_24,
    steerLock: 0.5,
  ...
  },
  {
    ...
    scale: 0.9095,
    mass: 1670,
    engineId: 'engine_umz_451m',
    gearboxId: 'gearbox_uaz469_4',
    tankLitres: 78,
    wheelGrip: 0.59,
    suspension: SUSP_TRUCK,
    steerLock: 0.55,
  ...
  },
  {
    ...
    scale: 0.921547,
    mass: 4300,
    engineId: 'engine_zil130_v8',
    gearboxId: 'gearbox_zil130_5',
    tankLitres: 140,
    wheelGrip: 0.55,
    suspension: SUSP_TRUCK,
    steerLock: 0.45,
  ...
  },
  {
    ...
    scale: 0.9201,
    mass: 1045,
    engineId: 'engine_uzam_412',
    gearboxId: 'gearbox_moskvich_4',
    tankLitres: 45,
    wheelGrip: 0.56,
    suspension: SUSP_ZHIGULI,
    steerLock: 0.525,
  ...
  },
  {
    ...
    scale: 1.01229,
    mass: 4830,
    engineId: 'engine_paz_zmz5234',
    gearboxId: 'gearbox_paz_4',
    tankLitres: 105,
    wheelGrip: 0.52,
    suspension: SUSP_PAZ,
    steerLock: 0.42,
  ...
  },
  {
    ...
    scale: 0.95199,
    mass: 1850,
    engineId: 'engine_uaz_4178',
    gearboxId: 'gearbox_uaz3962_4',
    tankLitres: 85,
    wheelGrip: 0.59,
    suspension: SUSP_TRUCK,
    steerLock: 0.5,
...
const GTAV_CARS: readonly Entry[] = GTAV_SPECS.map((spec) => ({
  ...
  // unless the entry pairs a separate hub node of its own (a donor that weights
  // a visible hub/axle island to its own body-skin bone, extracted apart from
  // the shared wheel drawable by `tools/import-yft-vehicle.py`'s hub routing).
